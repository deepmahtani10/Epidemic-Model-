# Epidemic-Model-
A short project where I try to model an Epidemic using a simplified SI model coupled with Gaussian Processes and Monte Carlo Random Sampling
I randomly decided one day, that I wanted to create an SIR model that coupled Gaussian Processes with Monte Carlo Random Sampling and SFML with multithreading. I used gcc 15.2.0 to compile SFML from source here.
